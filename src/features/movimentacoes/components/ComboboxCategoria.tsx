...
export function ComboboxCategoria({
  ...
  return (
    ...
    >
      ...
      <Combobox.Trigger
        className={cn(
          "flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-border/60 bg-background/60 py-2 px-3.5 text-xs font-medium overflow-hidden transition-colors outline-none select-none dark:bg-input/30 dark:hover:bg-input/50",
